...
const JobsQueuePage = lazy(() => import('@/pages/operations/JobsQueuePage'));
const ProfessionalsManagementPage = lazy(() => import('@/pages/operations/ProfessionalsManagementPage'));
const CompaniesPage = lazy(() => import('@/pages/operations/CompaniesPage'));
const VerificationsPage = lazy(() => import('@/pages/operations/VerificationsPage'));
const JobsListPage = lazy(() => import('@/pages/operations/JobsListPage'));
const DispatchPage = lazy(() => import('@/pages/operations/DispatchPage'));
const CancellationsManagementPage = lazy(() => import('@/pages/operations/CancellationsManagementPage'));
const DisputesPage = lazy(() => import('@/pages/operations/DisputesPage'));
const RefundsAdjustmentsPage = lazy(() => import('@/pages/operations/RefundsAdjustmentsPage'));
const PaymentsOverviewPage = lazy(() => import('@/pages/operations/PaymentsOverviewPage'));
        ...
        <Route element={<AuthGuard />}>
          <Route element={<MainLayout />}>
            ...
            <Route
              path="jobs-queue"
              element={
                <RouteErrorBoundary routeName="Jobs Queue">
                  <JobsQueuePage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="professionals"
              element={
                <RouteErrorBoundary routeName="Professionals Management">
                  <ProfessionalsManagementPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="companies"
              element={
                <RouteErrorBoundary routeName="Companies">
                  <CompaniesPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="verifications"
              element={
                <RouteErrorBoundary routeName="Verifications">
                  <VerificationsPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="jobs-list"
              element={
                <RouteErrorBoundary routeName="Jobs List">
                  <JobsListPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="dispatch"
              element={
                <RouteErrorBoundary routeName="Dispatch">
                  <DispatchPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="cancellations"
              element={
                <RouteErrorBoundary routeName="Cancellations Management">
                  <CancellationsManagementPage />
                </RouteErrorBoundary>
              }
            />
            <Route
            ...
            />
            <Route
              path="refunds-adjustments"
              element={
                <RouteErrorBoundary routeName="Refunds & Adjustments">
                  <RefundsAdjustmentsPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              ...
              element={
                <RouteErrorBoundary routeName="Payments Overview">
            ...
            <Route
              ...
              element={
                <RouteErrorBoundary routeName="Transactions Ledger">
                  <TransactionsLedgerPage />
                </RouteErrorBoundary>
              }
            />
            <Route
              path="payouts"
              element={
                <RouteErrorBoundary routeName="Payouts to Professionals">
                  <PayoutsToProfessionalsPage />
                </RouteErrorBoundary>
              }
            />
            <Route
